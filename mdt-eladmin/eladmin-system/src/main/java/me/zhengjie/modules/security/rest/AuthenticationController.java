...
public class AuthenticationController {
  ...
  public ResponseEntity login(@Validated @RequestBody AuthorizationUser authorizationUser){
    ...
    //System.out.println("11111111111111111111111111111111111111111111111111111111-------------"+SecurityUtils.getUsername());
   ...
   */
  @Log("用户微信登录")
  @PostMapping(value = "${jwt.auth.weChatPath}")
  public ResponseEntity loginByWx(@Validated @RequestBody AuthorizationUser authorizationUser){
    final JwtUser jwtUser = (JwtUser) userDetailsService.loadUserByUsername(authorizationUser.getUsername());
