...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers("/audit/aa").anonymous()
                
                .antMatchers("/api/codeWX").anonymous()
                // swagger start
                ...
                .antMatchers("/api/ccccc").anonymous()
                .antMatchers("/api/username").anonymous()
                .antMatchers("/api/callBack").anonymous()
                .antMatchers("/api/getUserByOpenId").anonymous()
                .antMatchers("/api/getAppletOpenId").anonymous()
                .antMatchers("/api/getWechatAppletUnionId").anonymous()
                 // swagger end
                .antMatchers("/uer/rs").anonymous()
               
                .antMatchers("/api/users/updateWx").anonymous()
                // 接口限流测试
