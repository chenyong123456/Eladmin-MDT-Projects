...
import cn.knowimage.service.CRUDService;
...
public class CRUDController {
     ...
     * @return ClincialResult
     */
    @RequestMapping(value = "/getMdtRegionOrOther",method = RequestMethod.GET)
    public ClincialResult getMdtRegionOrOther(@RequestParam(value = "uid",required = false, defaultValue = "0") Integer uid){
        System.out.println("**************************查询MDT的主导科室和其他科室的数据列表**************************");
        System.out.println("登陆人的id----->:" + uid);
        ClincialResult mdtGoalList = crudService.getMdtRegionOrOther(uid);
        System.out.println("**************************查询MDT的主导科室和其他科室的数据列表**************************");
        return mdtGoalList;
